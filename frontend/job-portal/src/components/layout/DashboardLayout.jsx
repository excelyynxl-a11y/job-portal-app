...
import { Briefcase, Building2, LogOut, Menu, SidebarOpen, X } from 'lucide-react';
...
const DashboardLayout = ({activeMenu, children}) => {
    ...
    return (
        <div className='flex h-screen bg-gray-50'>
            ...
            >
                {/* top navbar */}
                <header className='bg-white/80 backdrop-blur-sm border-b border-gray-200 h-16 flex items-center justify-between px-6 sticky top-0 z-2'>
                    <div className='flex item-center space-x-4'>
                        ...
                        <div>
                            ...
                            <p className='text-sm text-gray-500 hidden sm:block'>
                                Here's what happening with yout jobs today.
                            </p>
                        </div>
                    </div>
