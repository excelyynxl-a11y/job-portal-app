...
const ApplicantProfileViewer = ({
    ...
    const onChangeStatus = async (e) => {
        ...
        try {
            const response = await axiosInstance.put(
                API_PATHS.APPLICATION.UPDATE_STATUS(selectedApplicant._id),
                { status: newStatus }
            );
    ...
    return (
        <div className='fixed inset-0 bg-rgba[0,0,0,0.2] bg-opacity-50 flex items-center justify-center p-4 z-20'>
                ...
                <div className='p-6'>
                    ...
                    <div className='mt-4'>
                        ...
                        <select
                            ...
                            disabled={loading}
                            className='w-full border border-gray-300 rounded-lg p-2 focus:ring-blue-500 focus:border-blue-700'
                        >
