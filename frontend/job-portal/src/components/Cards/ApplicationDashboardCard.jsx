...
const ApplicationDashboardCard = ({
  ...
  return (
    <div className='flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-gray-200 transition-color'>
      <div className='flex items-center space-x-4'>
        ...
        <div>
          <h4 className='text-[15px] font-medium text-gray-500'>
            {applicant.name}
          </h4>
