...
const JobCard = ({
    ...
    const jobTypeConfig = {
        ...
        'Intership': 'bg-orange-100 text-orange-800',
            ...
            <div className='flex items-start justify-between mb-4'>
                <div className='flex items-start gap-4'>
                    ...
                    <div className='flex-1'>
                        <h3 className='font-semibold text-gray-500 text-base group-hover:text-blue-600 transition-colors leading-sm'>
                            {job?.title}
                        </h3>
                ...
                {user && (
                    ...
                    >
                        <Bookmark className={`w-5 h-5 hover:text-blue-600 ${
                            job?.isSaved || saved ?
                            'text-blue-600'
                            :
                            'text-gray-400'
            ...
            <div className='mb-5'>
                <div className='flex items-center gap-2 text-sm'>
                    ...
                    <span className={`px-3 py-1 rounded-full font-medium ${
                        jobTypeConfig[job.type] || 'bg-gray-100 text-gray-800'
                    }`}>
                        {job?.type}
                    </span>
                            ...
                            (
                                !hideApply && (
                                    <button
                                        ...
                                        className='bg-gradient-to-r from-blue-50 to-blue-60 text-sm text-blue-700 hover:text-white px-6 py-2.5 rounded-xl hover:from-blue-500 hover:to-blue-600 transition-all duration-200 font-semibold transform hover:-translate-y-0.5'
                                    >
                                        Apply Now
                                    </button>
                                )
