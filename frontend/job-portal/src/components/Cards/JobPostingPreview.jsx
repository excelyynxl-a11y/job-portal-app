                    ...
                    <div className=''>
                        ...
                        <div className='relative bg-white px-0 pb-8 mt-8 border-b border-gray-100'>
                            <div className='relative z-10'>
                                ...
                                <div className='flex flex-wrap gap-3 mt-6 md:mt-0'>
                                    ...
                                    <span className='px-4 py-2 text-sm bg-purple-50 text-purple-700 font-semibold rounded-full border border-purple-300'>
                                        {
                        ...
                        <div className='px-0 pb-8 space-y-8'>
                            ...
                            <div className='relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl'>
                                <div className='absolute top-0 right-0 w-12 h-32 bg-gradient-to-b from-emerald-400/10 to-teal-400/10 rounded-full -translate-y-10 translate-x-16'>
                                </div>
                                <div className='relative z-10'>
                                    <div className='flex items-center justify-between'>
