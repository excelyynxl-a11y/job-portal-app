...
import { employerFeature, jobSeekerFeature } from '../../../utils/data'
    ...
    <section className='py-20 bg-white relative overflow-hidden'>
        <div className='container mx-auto px-4 relative z-10'>
            <div className='text-center mb-16'>
                ...
                <p className='text-xl gray-600 max-w-3xl mx-auto'>
                    Whether you're looking for your next opportunity or the perfect
                    candidate, we have the toos and features to make it happen.
                </p>
            </div>
            ...
            <div className='grid md:grid-cols-2 gap-16 lg:gap-24'>
                ...
                <div>
                    ...
                    <div className='space-y-8'>
                        {jobSeekerFeature.map((feature, index) => (
                            ...
                            >
                                <div className='flex-shrink-0 w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center group-hover:bg-blue-200 transition-color'>
                ...
                <div>
                    ...
                    <div className='space-y-8'>
                        {employerFeature.map((feature, index) => (
                            <div
                                key={index}
