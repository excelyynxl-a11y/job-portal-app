import { AlertCircle, Building2, CheckCircle, Eye, EyeOff, Loader, Lock, Mail, Upload, User, UserCheck } from 'lucide-react';
...
const SignUp = () => {
  ...
  // account creation successfull popup
      ...
      >
        <div className='text-center mb-8'>
          ...
          <p className='text-sm text-gray-600'>
            Join thousands of professional finding thier dream job.
          </p>
        </div>
        <form 
        ...
        >
          ...
          <div>
            ...
            <div className='grid gried-cols-2 gap-4'>
              {/* jobseeker role button */}
              <button
                type='button'
