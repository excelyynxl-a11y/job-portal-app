...
const SavedJobs = () => {
  ...
  const handleUnsaveJob = async (jobId) => {
    try {
      ...
      toast.success('Job removed succesfully.');
      getSavedJobs();

    } catch (error) {
      toast.error('Something went wrong! Trya again later.')
    }
  }
          ...
          <div className='bg-white p-6 rounded-lg'>
            ...
            <div className='px-0 pb-8 space-y-8'>
              ...
              {savedJobList.length === 0 ?
                (
                  <div className='text-center py-16 lg:py-20 bg-white/60 backdrop-blur-xl rounded-2xl border border-white/200'>
                    ...
                    <p className='text-gray-600 mb-6'>
                      Start saving jobs that interest you to view later.
                    </p>
